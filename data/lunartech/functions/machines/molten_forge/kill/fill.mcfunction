...
kill @e[type=item,distance=..5,nbt={Item:{id:"minecraft:cobbled_deepslate",Count:1b}},limit=16]
kill @e[type=item,distance=..5,nbt={Item:{id:"minecraft:polished_andesite",Count:1b}},limit=8]
kill @e[type=item,distance=..5,nbt={Item:{id:"minecraft:cobbled_deepslate_slab",Count:1b}},limit=6]
kill @e[type=item,distance=..5,nbt={Item:{id:"minecraft:cobbled_deepslate_stairs",Count:1b}},limit=4]
kill @e[type=item,distance=..5,nbt={Item:{id:"minecraft:magma_block",Count:1b}},limit=2]
