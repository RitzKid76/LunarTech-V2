...
execute if entity @s[tag=Z-] run particle minecraft:dust .85 0 0 .7 ~ ~ ~-1.5 .84 0 0 0 8 normal @a
execute if entity @s[tag=Z-] run particle minecraft:dust .85 0 0 .7 ~ ~ ~.5 .84 0 0 0 8 normal @a
...
execute if entity @s[tag=X-] run particle minecraft:dust .85 0 0 .7 ~-.5 ~ ~1.5 .36 0 0 0 8 normal @a
execute if entity @s[tag=X-] run particle minecraft:dust .85 0 0 .7 ~-1.5 ~ ~ 0 0 .84 0 8 normal @a
execute if entity @s[tag=X-] run particle minecraft:dust .85 0 0 .7 ~.5 ~ ~ 0 0 .84 0 8 normal @a
