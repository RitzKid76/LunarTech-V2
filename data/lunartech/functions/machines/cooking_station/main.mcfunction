...
execute positioned ~ ~2 ~ as @e[tag=snapped_item,distance=..1,tag=!restrict] unless entity @e[tag=crafted,distance=..2.5] run function lunartech:machines/cooking_station/recipes/main
