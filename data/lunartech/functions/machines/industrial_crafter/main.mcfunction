...
execute positioned ~ ~2 ~ as @e[tag=snapped_item,tag=!restrict,distance=..1] unless entity @e[tag=crafted,distance=..2.5] run function lunartech:machines/industrial_crafter/recipes/main
