...
execute unless entity @e[tag=!restrict,nbt={Item:{tag:{copper_sheet:1}}},distance=..1,tag=three] run tag @e[tag=!restrict,nbt={Item:{tag:{copper_sheet:1}}},distance=..1,scores={count=3..},limit=1] add three
