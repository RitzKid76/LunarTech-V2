...
execute at @e[tag=air_compressor_side,distance=..2] positioned ~ ~1 ~ run function lunartech:machines/item_snapping
execute at @e[tag=air_compressor_side,distance=..2] positioned ~ ~1 ~ as @e[type=item,tag=snapped_item,distance=..1] run function lunartech:machines/air_compressor/recipes/side
