...
tag @e[tag=rubber_ball,distance=0,sort=nearest,limit=1] add dyee
tag @e[tag=rubber_ball_display,distance=0,sort=nearest,limit=1] add dyee_display
...
execute at @s run function lunartech:objects/machines/craft_item