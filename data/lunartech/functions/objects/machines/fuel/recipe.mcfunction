...
function lunartech:objects/machines/fuel/get
...
execute if entity @e[tag=oxygenator,distance=..2] run scoreboard players operation #new fuel -= #oxygenator_max fuel

execute if score @s fuel matches 1.. if score #new fuel matches ..0 run function lunartech:objects/machines/fuel/output