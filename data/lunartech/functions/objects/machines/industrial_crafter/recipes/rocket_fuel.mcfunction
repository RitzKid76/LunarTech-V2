...
execute if score bottle_of_gasoline count matches 4.. if score bottle_of_kerosese count matches 4.. run function lunartech:objects/machines/industrial_crafter/outputs/rocket_fuel
