...
execute if score bottle_of_chemical_concoction count matches 3.. run function lunartech:objects/machines/industrial_crafter/outputs/chemical_concoction_drum
