...
execute positioned ~ ~2 ~ as @e[tag=snapped_item,tag=!restrict,distance=..1] unless entity @e[tag=crafted,distance=..2.5] run function lunartech:objects/machines/cooking_station/recipes/main
tag @s remove crafted

execute unless block ~ ~2 ~ brown_stained_glass run function lunartech:objects/machines/cooking_station/kill